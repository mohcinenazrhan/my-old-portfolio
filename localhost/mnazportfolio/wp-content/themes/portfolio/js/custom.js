...
var modalImg = document.getElementById("imgtakelook");
var captionText = document.getElementById("caption");

$(".TakeLookStyle").click(function(){
    modal.style.display = "block";
	//console.log($(this).attr('data-file'));
    modalImg.src = $(this).attr('data-file')==undefined ?'wp-content/themes/portfolio/files/Soon.jpg':$(this).attr('data-file');
    captionText.innerHTML = $(this).attr('data-title');
...
$("#openpdf").click(function(event) {
	...
	$webroot = $("#openpdf").attr('data-file');
	javascipt:window.open($webroot+'/files/MN_CV.pdf');
...
// for the menu portfolio

//default selected elemnt 'ALL'
$("#portfolio-sorting li:first-child a").addClass('active');
	...
	$("#fixedmenu a ,.narrow-p a").on('click', function(event) {
		  ...
		  if (this.hash !== "") {
			...
			//$("#fixedmenu .collapse").collapse('hide');
		  } // End if
...
(function() {
    ...
    WebP.onload = WebP.onerror = function() {
        if (WebP.height != 2) {
			srcimage = 'http://localhost/mnazportfolio/wp-content/themes/portfolio/images/';
			$('.logo').css('background','url('+srcimage+'MrNaz-LogoLoading.png)');
			$('#mn-logo').attr("src",''+srcimage+'MohcineNAZ-MrNAZ-logo.png');
			$('#photoprofile').attr("src",''+srcimage+'MohcineNAZ-MrNAZ.png');
        }
    };
